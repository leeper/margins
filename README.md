...
Users interested in generating predicted (fitted) values, such as the "predictive margins" generated by Stata's `margins` command, should consider using `prediction()` from the [**prediction**](https://cran.r-project.org/package=prediction) package.
...
```
##  Factor .at   dy/dx Std.Err. z value Pr(>|z|)   2.50%  97.50%
...
![plot of chunk marginsplot](http://i.imgur.com/8tqt14Y.png)
...
##  marginal_effects(x) 11.61389 12.006 13.08107 12.21013 13.11941 58.25912   100
```
...
## Unit: milliseconds
##        expr      min       lq     mean   median       uq      max neval
##  margins(x) 89.07287 91.16608 94.15187 92.42205 94.39875 180.0772   100
```
...
![plot of chunk cplot1](http://i.imgur.com/XyRdbbW.png)
...
![plot of chunk cplot2](http://i.imgur.com/efzTTT1.png)
...
![plot of chunk cplot3](http://i.imgur.com/IfM7uQD.png)
...
![plot of chunk persp1](http://i.imgur.com/vLWvcsF.png)
...
![plot of chunk persp2](http://i.imgur.com/fnMgnDf.png)
...
![plot of chunk image11](http://i.imgur.com/TWUpCD2.png)
