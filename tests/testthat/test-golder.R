...
test_that("Golder Interaction Case 1a/1b correct", {
    ...
    expect_equal(unclass(e[,"z"]), dydz, label = "dy/dz correct")
...
test_that("Golder Quadratic Case 3a/3b correct", {
    ...
    expect_equal(unclass(e[,"z"]), dydz, label = "dy/dz correct")
    #expect_equal(sedydz, s[s[["Factor"]] == "x", "Std.Err."], label = "Var(dy/dz) correct")
})
