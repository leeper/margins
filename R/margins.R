...
#' 
#' @return A data frame of class \dQuote{margins}, composed of one or more row-stacked marginal effects estimates. If \code{at = NULL} (the default), then the data frame will have a number of rows equal to the original data. Otherwise, the number of rows will be a multiple thereof based upon the intersection of values specified in \code{at}.
#' @author Thomas J. Leeper
#' @references
